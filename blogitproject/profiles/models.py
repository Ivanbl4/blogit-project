...
class Profile(models.Model):
    ...
    profile_image = models.ImageField(upload_to='profile_image/%Y/%m/%d', default='default/default-profile-logo.jpeg', verbose_name='Profile Image', blank=True)
    ...
    def change_profile_image_thumbnail(self):
        self.profile_image_thumbnail = generate_profile_thumbnail(self.id, self.profile_image.name, w=300, h=400)
